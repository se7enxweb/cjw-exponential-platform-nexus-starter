<?php
// URI:       design:setup/clear_cache.tpl
// Filename:  extension/ngadminui/design/ngadminui/templates/setup/clear_cache.tpl
// Timestamp: 1771144664 (Sun Feb 15 8:37:44 UTC 2026)
$oldSetArray_6864b82704ff3c9506d5ab1c958e38dc = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
unset( $var );
$text .= '
<form id="clearcache" action="/setup/cachetoolbar" method="post">';
...
$text .= '<select class="form-control input-sm"';
unset( $var );
unset( $var1 );
unset( $var2 );
unset( $var2 );
...
$setArray = $oldSetArray_6864b82704ff3c9506d5ab1c958e38dc;
$tpl->Level--;
?>
