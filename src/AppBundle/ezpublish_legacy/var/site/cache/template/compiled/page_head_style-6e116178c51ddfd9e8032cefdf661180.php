<?php
// URI:       design:page_head_style.tpl
// Filename:  design/admin/templates/page_head_style.tpl
// Timestamp: 1770728179 (Tue Feb 10 12:56:19 UTC 2026)
$oldSetArray_d83d7d000c1c3e73fe1946c0524cb6a7 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
  ';
$oldRestoreIncludeArray_951fc9f4383aa5ed0d6b07db8586001d = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/site/cache/template/compiled/page_head_style_inline-dab0d8e6fa3431e2d1c9811a54a17279.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/site/cache/template/compiled/page_head_style_inline-dab0d8e6fa3431e2d1c9811a54a17279.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_951fc9f4383aa5ed0d6b07db8586001d;
...
$setArray = $oldSetArray_d83d7d000c1c3e73fe1946c0524cb6a7;
$tpl->Level--;
?>
