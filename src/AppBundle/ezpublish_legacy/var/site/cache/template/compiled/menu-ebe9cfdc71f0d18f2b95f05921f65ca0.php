...
// Filename:  extension/ngadminui/design/ngadminui/templates/parts/content/menu.tpl
// Timestamp: 1771144664 (Sun Feb 15 8:37:44 UTC 2026)
$oldSetArray_6bce410affe428d43798216808544340 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '<div id="content-tree">
    ...
    <h4 class="leftmenu-hl">Inhalts-Struktur</h4>
    ...
    <div id="contentstructure">
        ';
$oldRestoreIncludeArray_eea2fcf10838b68f745fb9668669859d = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$restoreIncludeArray = $oldRestoreIncludeArray_eea2fcf10838b68f745fb9668669859d;
...
$text .= ' title="Den Inhalt des Papierkorbs ansehen und verwalten."><i class="fa fa-trash-o"></i>&nbsp;<span>Papierkorb</span></a>
    </div>
    ';
}
unset( $if_cond );
...
';
$oldRestoreIncludeArray_19ddb1abb8c3dd475514864f1c51a22d = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$restoreIncludeArray = $oldRestoreIncludeArray_19ddb1abb8c3dd475514864f1c51a22d;


$setArray = $oldSetArray_6bce410affe428d43798216808544340;
$tpl->Level--;
?>
